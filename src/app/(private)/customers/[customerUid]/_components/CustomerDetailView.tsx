...
import CustomerRoleLabels from "./CustomerRoleLabels";
import CustomerPriceInfo from "./CustomerPriceInfo";
...
const CustomerDetailView = ({
  ...
  if (!customer || !customerUid) return <div>?</div>;
  ...
  return (
    <div>
      <div className="flex flex-col gap-4 p-5 pt-0">
        ...
        {!isEditing && <CustomerInfo customerId={customerUid} />}
      </div>
