...
import { Customer, Label, CustomerRoleFilters } from "@/types/customer";
...
interface CustomerSelectModalContainerProps {
  open: boolean;
  onClose: () => void;
...
const CustomerSelectModalContainer = ({
  open,
  onClose,
  onConfirm,
  selectedCustomers: selectedCustomersProp,
}: CustomerSelectModalContainerProps) => {
...
export default CustomerSelectModalContainer;
